...
app = Flask(__name__)
app.secret_key = 'a_secure_random_secret_key'  # In production, use a secure, random secret key
...
GENRE_TRACKS = {
    "Corrido": [
        # Example Corrido tracks (replace with actual Spotify track URIs)
    ...
    "Boom Bap": [
        # Example Boom Bap tracks (replace with actual Spotify track URIs)
    ...
    "Rock": [
        # Example Rock tracks (replace with actual Spotify track URIs)
...
def create_playlist():
    ...
    return f"Playlist created successfully! Check your Spotify account. Playlist ID: {playlist_id}"
